        ...
        <div class="product-content row mb-minus-24" id="MixItUpDA2FB7">
                ...
                <div class="row mb-minus-24 sticky">
                    <div class="col-lg-12 col-sm-6 col-6 cr-product-box mb-24">
                        <div class="cr-product-tabs">
                            <ul class="cr-product-tabs">
                                <li class="active" data-filter="all">
                                    <a href="index.php?act=home.php">All</a>
                                ...
                                foreach ($listcategory as $category) {
                                    ...
                                    $activeClass = (isset($_GET['idcategory']) && $_GET['idcategory'] == $idcategory) ? 'active' : '';
                                    echo '<li data-filter=".snack" class="' . $activeClass . '"><a href="' . $linkcategory . '">' . $namecategory . '</a><span class="arrow">→</span></li>';
                                }
                                ?>
                            </ul>
                        </div>
                    ...
                    <div class="cr-shop-price">
                        ...
                        <div class="price-range-slider mb-3">
                            ...
                            <!-- Button Filter -->
                            <button type="button" class="cr-button" id="filter-price">Filter</button>
                        </div>
                    </div>
            ...
            <div class="col-xl-9 col-lg-8 col-12 mb-4">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
                    <?php
                    $filteredProducts = $listproduct; // Dữ liệu mặc định là tất cả sản phẩm
                    if (isset($_GET['price'])) {
                        list($minPrice, $maxPrice) = explode('-', $_GET['price']); // Tách khoảng giá từ URL
                        $filteredProducts = array_filter($listproduct, function ($product) use ($minPrice, $maxPrice) {
            ...
            <a href="' . $linkproduct . '" class="no-underline">
                <div class="cr-product-card">
                    ...
                    <div class="cr-product-details">
                        ...
                        <a href="index.php?act=productdetails&idproduct=' . $idproduct . '" class="text-start d-block">' . $nameproduct . '</a>
